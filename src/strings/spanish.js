...
const SPANISH: TranslateStringsType = {
  ...
  legalCustodySentLink: 'Haz clic aqui para una copia del texto de T.C.A. § 34-6-305 (2017)',
  ...
  lawCanBeFound: 'Una copia del Codigo Tennessee (T.C.A. 2017) puede ser encontrada',
  here: 'aqui',
