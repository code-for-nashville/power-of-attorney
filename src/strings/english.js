const ENGLISH = {
  ...
  city: 'City',
  state: 'State',
  pleaseAddZip: 'Please add a zip code.',
  zip: 'Zip Code'
  numberOfChildren: 'Number of children',
  minorName: '1. Minor Child\'s Name',
  pleaseAddChildName: 'Please add the name of each child.'
  motherName: '2. Mother/Legal Guardian’s Name & Address',
  fatherName: '3. Father/Legal Guardian’s Name & Address',
  caregiverName: '4. Caregiver’s Name & Address',
  parentalSatus: '5. Parental Status',
  pleaseAddParentalStatus: 'Please add a parental status.',
  pleaseAddReason: 'Please add a reason.'
  bothParents: 'Both parents are living, have legal custody of the minor child and have signed this document',
  parentDeceased: 'One parent is deceased',
  legalCustodySigned: 'One parent has legal custody of the minor child and both parents have signed this document and consent to the appointment of the caregiver',
  legalCustodySent: 'One parent has legal custody of the minor child, and has sent by Certified Mail, Return Receipt requested, to the other parent at last known address, a copy of this document and a notice of the provisions in § 34-6-305;',
  legalCustodyNoConsent: 'The non-custodial parent has not consented to the appointment and consent cannot be obtained.',
  ...
  formWithErrors: 'The form has errors',
  faq: 'Frequently Asked Questions',
  whatIsPOA: 'What is a Power of Attorney?',
  poaIs: 'A Power of Attorney is a legal document in which a parent authorizes another adult to care for their minor child. By signing a Power of Attorney, the parent does not give up any parental rights.',
  WhatIsThisFormUsedFor: 'What is this form used for?',
  formWasCreated: 'This form was created for immigrant parents in Tennessee who face the threat of being detained and/or deported. It allows parents to grant a caregiver temporary rights to make decisions for their minor child on their behalf. The Power of Attorney goes into effect only if the parents have been detained or deported. Completion of this form, along with the proper signatures, authorizes the caregiver to enroll the child in school, obtain medical treatment for the child, and provide for the child’s food, housing, and travel.',
  ...
  lawCanBeFount: 'The law can be found',
