...
const ENGLISH = {
  ...
  parentalStatus: 'Parental Custody (check the appropriate custody status)',
  ...
  temporaryAuthority: 'Temporary caregiving authority regarding the minor child/children is being given to the caregiver',
  effectiveImmediately: 'effective immediately upon signing this document, but with the intention that the caregiver(s) will only take charge of my/our child/children if and when one or more of the following type(s) of hardship may occur (check at least one below)',
  onlyUnderHardship: 'only if and when one or more of the following type(s) of hardship may occur (check at least one below)',
  seriousIllness: 'the serious illness of a parent or legal guardian',
  mentalCondition: 'the physical or mental condition of the parent or legal guardian or the child/children is such that care and supervision of the child/children cannot be provided',
  uninhabitability: 'the loss or uninhabitability of the child/children’s home as a result of a natural disaster or otherwise',
  mentalHealthTreatment: 'the need for medical or mental health treatment (including substance abuse treatment) by the parent or legal guardian',
  ...
  undersignedAuthorize: 'I/We the undersigned, authorize the named caregiver to do one or more of the following',
  enrillInSchool: 'enroll the child/children in school and extracurricular activities (including but not limited to Boy Scouts, Boys & Girls Club, etc.)',
  healthTreatment: 'obtain medical, dental, and mental health treatment for the child/children',
  accessEducation: 'access educational and medical records, per HIPAA rules, as needed',
  provideNecessities: 'provide for the child/children’s food, lodging, housing, recreation, and travel',
  ...
  makeTravelArrangements: 'to make travel arrangements for the child/children to travel outside the United States, together with the caregiver or on their own, for the SOLE purpose of being reunited with me/us in our country of residence; and/or',
  grantPowers: 'I/We grant the following additional power(s) to the named caregiver',
  ...
  mayBeTerminated: 'I/We understand that this document may be terminated in another written document signed by either parent with legal custody or by any order of a court with competent jurisdiction.',
