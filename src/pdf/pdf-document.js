...
export const SUCCESSOR_CAREGIVER_ADDRESS = 'successorCaregiverAddress'
...
let createDocDefinition = (inputInfo, childName) => {
  ...
  let restOfChildren = inputInfo.childrenNames
    .slice(1, inputInfo.childrenNames.length)
    .map(childName => ({
      columns: [
        {text: '', width: 50},
        {
  ...
  const content = [
    {
      text: [
        {
          text: 'POWER OF ATTORNEY FOR CARE OF A MINOR CHILD OR CHILDREN\n\n',
          alignment: 'center',
          bold: true,
          decoration: 'underline'
        },
    ...
    {
      columns: [
        {text: "Mother/Legal Guardian's Full Name:", width: '*'},
        {
    ...
    {
      columns: [
        {text: "Father/Legal Guardian's Full Name:", width: '*'},
        {
    ...
    {
      text: '2. 	Initial Caregiver’s Full Name, Relationship, Address, & Phone:'
    },
    {
      text: [
        {
        ...
        {
          text: ` ${inputInfo[CAREGIVER_ADDRESS].relationship}  \n\n`,
          decoration: 'underline',
          alignment: 'center'
        },
        {
        ...
        {
          text: ` ${inputInfo[CAREGIVER_ADDRESS].phone}  \n\n`,
          decoration: 'underline',
          alignment: 'center'
        }
      ]
    ...
    },
    {
      text: [
        {
          text: `  ${inputInfo[SUCCESSOR_CAREGIVER_ADDRESS].name}  \n\n`,
          decoration: 'underline',
          alignment: 'center'
        },
        {
          text: ` ${inputInfo[SUCCESSOR_CAREGIVER_ADDRESS].relationship}  \n\n`,
          decoration: 'underline',
          alignment: 'center'
        },
        {
          text: `  ${inputInfo[SUCCESSOR_CAREGIVER_ADDRESS].street_address}, ${
        ...
        {
          text: ` ${inputInfo[SUCCESSOR_CAREGIVER_ADDRESS].phone}  \n\n`,
          decoration: 'underline',
          alignment: 'center'
        }
      ]
